...
import rubis.utilities.DatesNotSpecifiedException;
import rubis.utilities.EndDateNotSpecifiedException;
import rubis.utilities.StartDateNotSpecifiedException;
        ...
        if ((this.startDate != null) && (this.endDate != null)) {
            ...
            while (resultSet.next()) {
                ...
                AvisClient avisClient =
                        new AvisClient(BigInteger.valueOf(resultSet.getLong(Rubis.REQUEST_FOR_PAYMENT_ID_COL_NAME)));
                ...
                for (int i = 1; i < rsmd.getColumnCount() + 1; i++) {
                    ...
                    if (!rsmd.getColumnName(i).equals(Rubis.REQUEST_FOR_PAYMENT_ID_COL_NAME)) {
