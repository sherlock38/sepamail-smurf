...
/**
 * The Configuration class allows to read and persist the Rubis application configuration settings
 * 
    ...
    private void readConfiguration() throws IOException {
        ...
        try {
            ...
            rubisProperties.load(new FileInputStream(Utilities.getCurrentWorkingDirectory() + 
                    System.getProperty("file.separator") + Rubis.CONFIG_FILE_NAME));
            ...
            for (Iterator<String> it = confMap.keySet().iterator(); it.hasNext();) {
                ...
                try {
                    ...
                    Rubis.logController.log(Level.WARNING, ConfigurationDao.class.getSimpleName(),
