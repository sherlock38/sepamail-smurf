...
public class SEPAMailDocumentMailer {
    ...
    private void mailAsAttachment(AvisClient avisClient) throws MessagingException {
        ...
        RubisAuthenticator rubisAuthenticator = new RubisAuthenticator(this.username, this.password);

        // Mailer properties
        Properties properties = new Properties();
        properties.setProperty("mail.smtp.submitter", rubisAuthenticator.getPasswordAuthentication().getUserName());
        properties.setProperty("mail.smtp.auth", "true");
        properties.setProperty("mail.smtp.host", this.host);
        properties.setProperty("mail.smtp.port", String.valueOf(this.port));

        // Mailer session
        Session session = Session.getInstance(properties, rubisAuthenticator);
