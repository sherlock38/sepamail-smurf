...
public class SEPAMailDocumentPrinter {
    ...
    private String generateSepaMailXml(AvisClient avisClient) throws FileNotFoundException, IOException {
        ...
        try {
            tokens.put("#SMURF#date_avis_iso#", isoDateTimeFormat.format((Date)avisClient.getAttribute("date_avis")));
        } catch (RequestForPaymentAttributeNotFoundException ex) {
            Rubis.logController.log(Level.WARNING, SEPAMailDocumentPrinter.class.getSimpleName(),
                    ex.getLocalizedMessage());
        ...
        try {
            tokens.put("#SMURF#date_paiement#", isoDateFormat.format((Date)avisClient.getAttribute("date_paiement")));
        } catch (RequestForPaymentAttributeNotFoundException ex) {
            Rubis.logController.log(Level.WARNING, SEPAMailDocumentPrinter.class.getSimpleName(),
                    ex.getLocalizedMessage());
            tokens.put("#SMURF#date_paiement#", "#NA");
