...
import rubis.view.RubisMainJFrame;

/**
 * The MainWindowController controls the Rubis main application frame and responds to the GUI events.
 * 
...
public class MainWindowController extends WindowAdapter implements ComponentListener {
    ...
    private static RubisMainJFrame view;
     ...
     */
    public static RubisMainJFrame getView() {
        return view;
    }
    ...
    public void showDialogMessage(String message, int messageType) {
        ...
        JOptionPane.showMessageDialog(view, message, "SEPAmail RUBIS", messageType);
    }
