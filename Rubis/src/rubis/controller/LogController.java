...
import rubis.Rubis;
import rubis.utilities.LogFormatter;
...
public class LogController {
    ...
    private static final Logger LOGGER = Logger.getLogger(Rubis.class.getName());
    ...
    private LogController() {
        ...
        try {
            ...
            FileHandler logFileHandler = new FileHandler(Utilities.getCurrentWorkingDirectory() + 
                    System.getProperty("file.separator") + Rubis.LOG_FILE_NAME, true);

            // File handler properties
            logFileHandler.setFormatter(fileFormatter);

            // Create logger
            Logger logger = Logger.getLogger(Rubis.class.getName());
